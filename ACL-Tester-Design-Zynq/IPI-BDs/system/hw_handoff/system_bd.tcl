...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./timothystotts/fpga-serial-acl-tester-2/ACL-Tester-Design-Zynq/IPI-BDs
...
proc create_root_design { parentCell } {
  ...
  set seg_gpio_je [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 seg_gpio_je ]

  set ssd_mux_je [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 ssd_mux_je ]
  ...
  connect_bd_intf_net -intf_net MuxSSD_0_seg_gpio [get_bd_intf_ports seg_gpio_je] [get_bd_intf_pins MuxSSD_0/seg_gpio]
  connect_bd_intf_net -intf_net MuxSSD_0_ssd_mux [get_bd_intf_ports ssd_mux_je] [get_bd_intf_pins MuxSSD_0/ssd_mux]
  connect_bd_intf_net -intf_net PmodACL2_0_Pmod_out [get_bd_intf_ports jc] [get_bd_intf_pins PmodACL2_0/Pmod_out]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins PWM_1/PWM_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins PmodACL2_0/AXI_LITE_GPIO] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins PmodACL2_0/AXI_LITE_SPI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins PmodCLS_0/AXI_LITE_SPI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins MuxSSD_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  ...
  connect_bd_net -net PWM_0_pwm [get_bd_ports ld56_rgb] [get_bd_pins PWM_0/pwm]
  connect_bd_net -net PWM_1_pwm [get_bd_ports ld0123_basic] [get_bd_pins PWM_1/pwm]
  connect_bd_net -net PmodACL2_0_GPIO_Interrupt [get_bd_pins PmodACL2_0/GPIO_Interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins MuxSSD_0/ext_mux_clk] [get_bd_pins MuxSSD_0/s00_axi_aclk] [get_bd_pins PWM_0/pwm_axi_aclk] [get_bd_pins PWM_1/pwm_axi_aclk] [get_bd_pins PmodACL2_0/ext_spi_clk] [get_bd_pins PmodACL2_0/s_axi_aclk] [get_bd_pins PmodCLS_0/ext_spi_clk] [get_bd_pins PmodCLS_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins MuxSSD_0/s00_axi_aresetn] [get_bd_pins PWM_0/pwm_axi_aresetn] [get_bd_pins PWM_1/pwm_axi_aresetn] [get_bd_pins PmodACL2_0/s_axi_aresetn] [get_bd_pins PmodCLS_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_reset [get_bd_pins MuxSSD_0/ext_mux_rst] [get_bd_pins rst_ps7_0_50M/peripheral_reset]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MuxSSD_0/S00_AXI/S00_AXI_reg] -force
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PWM_1/PWM_AXI/PWM_AXI_reg] -force
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodACL2_0/AXI_LITE_GPIO/Reg0] -force
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodACL2_0/AXI_LITE_SPI/Reg0] -force
  assign_bd_address -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PmodCLS_0/AXI_LITE_SPI/Reg0] -force
